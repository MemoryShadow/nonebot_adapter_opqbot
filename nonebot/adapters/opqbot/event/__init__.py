...
LastEditTime: 2023-10-16 18:49:22
Description: 
...
\:\:\:
"""
from .base import (Event, EventData, GroupInfoModel, PrivateChatInfo,
                   UserPermission)
...
__all__ = [  # noqa
    'Event', 'EventData', 'GroupEventData', 'MsgHead', 'GroupInfoModel', 'PrivateChatInfo', 'UserPermission',
